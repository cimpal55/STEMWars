...
using STEMWars.Shared.Models.Data;
    ...
    internal sealed class CountriesMigration : ISubMigration
    {
        ...
        public void Up(Migration migration)
        {
            migration.Create.Table(TableName)
                .WithColumn(Country.Id).AsInt32().NotNullable().PrimaryKey().Identity()
                .WithColumn(Country.Name).AsString(250).Nullable()
                .WithColumn(Country.Code).AsString(150).Nullable();

            migration.Insert.IntoTable(TableName)
                .Rows(new Shared.Models.Data.CountryModel[]
                {
                    new() { Name = "Afghanistan", Code = "AF" },
                    new() { Name = "Aland Islands", Code = "AX" },
                    ...
                    new() { Name = "Netherlands Antilles", Code = "AN" },
                    ...
                    new() { Name = "Palestinian Territory", Code = "PS" },
                    ...
                    new() { Name = "Serbia and Montenegro", Code = "CS" },
                    ...
                    new() { Name = "United States Minor Outlying Islands", Code = "UM" },
                    ...
                    new() { Name = "Virgin Islands", Code = "VG" },
                    new() { Name = "Virgin Islands.", Code = "VI" },
